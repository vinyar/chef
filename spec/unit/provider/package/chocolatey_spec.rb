...
munin-node|1.6.1.20130823
  ...
  before do
    ...
    allow(provider).to receive(:shell_out!).with("#{choco_exe} list -r#{remote_list_args}", {:timeout => timeout}).and_return(remote_list_obj)
  end
  ...
  describe "#action_install" do
    ...
    context "when passing a source argument" do
      let(:remote_list_args) { " -source localpackages" }
  ...
  describe "#action_upgrade" do
    ...
    it "we request a version pin it tells us to use :install instead" do
